...
public class MessageDetailsImpl implements MessageDetails {
	...
	public String toString() {
		return "uid=" + String.valueOf(getUid()) + " text.length=" + (text != null ? text.length() : 0) + " raw.length="
				+ (raw != null ? raw.length() : 0) + " attachments="
				+ (messageAttachments != null ? messageAttachments.size() : 0) + " headers=" + mailHeaders.size();
	}
	...
	@Override
	public List<String> getCc(List<String> cc) {
		return cc;
	}
	...
	@Override
	public List<String> getBcc(List<String> bcc) {
		return bcc;
	}
}
