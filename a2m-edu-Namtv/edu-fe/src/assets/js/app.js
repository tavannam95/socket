!(function () {
  var a,
    ...
    i,
    m,
    c = document.querySelector(".navbar-menu")? document.querySelector(".navbar-menu").innerHTML: null,
    u = 7,
    g = "en"
  ...
  function L() {
    if(!document
      .getElementById("navbar-nav")) return false;
    var e =
      "/" == location.pathname ? "index.html" : location.pathname.substring(1);
    !(e = e.substring(e.lastIndexOf("/") + 1)) ||
      ((e = document
            .getElementById("navbar-nav").querySelector('[href="' + e + '"]')) &&
        (e.classList? e.classList.add("active"): '',
  ...
  function q() {
    if( !document
      .getElementById("vertical-hover")) return false;
    document
