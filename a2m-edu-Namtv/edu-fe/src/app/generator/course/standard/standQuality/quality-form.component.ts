...
export class QualityFormComponent implements OnInit {
  ...
  @Output()
  saveQua: EventEmitter<any> = new EventEmitter();
  @Output()
  ...
  constructor(
    ...
    public dialogRef: MatDialogRef<QualityFormComponent>,
  ...
  getListStandard(){
    this.standardService.getListStandBySubjectId(this.subjectId).subscribe((response) => {
      this.listStandards = response[CommonConstant.DETAIL_KEY];this.standardService.getListStandHistoryBySubjectId(this.subjectId).subscribe((response) => {
