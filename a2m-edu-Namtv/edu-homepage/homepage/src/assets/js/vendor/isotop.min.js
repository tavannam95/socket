(function (t) {
  ...
  function i(a) {
    if (a) {
      ...
      return (
        (a.bridget = function (t, e) {
          var r, s, i;
          (i = e).prototype.option ||
            ...
            (a.fn[r] = function (e) {
              if ("string" != typeof e)
                return this.each(function () {
                  ...
                  t
                    ? (t.option(e), t._init())
                    : ((t = new s(this, e)), a.data(this, r, t));
                });
              for (
                var t = p.call(arguments, 1), i = 0, o = this.length;
                i < o;
                i++
              ) {
                var n = this[i],
    ...
    function t(g) {
      ...
      return function (t) {
        if (
          ...
          o = x(e.height);
          return (
            !1 !== o && (i.height = o + (c ? 0 : p + l)),
            (i.innerWidth = i.width - (u + f)),
            (i.innerHeight = i.height - (p + l)),
  ...
  (function (n) {
    ...
    (t = o
      ...
      : function (t, e) {
          r(t);
          for (
            var i = t.parentNode.querySelectorAll(e), o = 0, n = i.length;
            o < n;
            o++
          )
            if (i[o] === t) return !0;
        ...
        for (var i = [], o = 0, n = (t = f.makeArray(t)).length; o < n; o++) {
          ...
          if (f.isElement(r))
            if (e) {
              p(r, e) && i.push(r);
              for (
                var s = r.querySelectorAll(e), a = 0, u = s.length;
                a < u;
                a++
              )
                i.push(s[a]);
    ...
    o.extend(n.prototype, e.prototype),
      ...
      (n.prototype.getPosition = function () {
        var t = a(this.element),
          ...
          e = isNaN(e) ? 0 : e,
          t = this.layout.size;
        (n -= i ? t.paddingLeft : t.paddingRight),
          (e -= o ? t.paddingTop : t.paddingBottom),
          (this.position.x = n),
          (this.position.y = e);
      }),
    ...
    (n.prototype._transitionTo = function (t, e) {
      ...
      this.setPosition(t, e),
        !r || this.isTransitioning
          ? ((i = t - i),
            (e -= o),
            (i = (o = this.layout.options).isOriginLeft ? i : -i),
            (e = o.isOriginTop ? e : -e),
            ((o = {}).transform = c(i, e)),
            this.transition({
              to: o,
      ...
      (n.prototype.moveTo = h ? n.prototype._transitionTo : n.prototype.goTo),
  ...
  (function (r, s) {
    ...
    return (
      ...
      (s.prototype.resizeContainer = function () {
        var t;
        !this.options.isResizingContainer ||
          ((t = this._getContainerSize()) &&
            (this._setContainerMeasure(t.width, !0),
            this._setContainerMeasure(t.height, !1)));
      }),
      (s.prototype._getContainerSize = a),
      ...
      (s.create = function (t, e) {
        ...
        return (
          Object.create
            ...
            : r.extend(i.prototype, s.prototype),
          ((i.prototype.constructor = i).defaults = r.extend({}, s.defaults)),
      ...
      (t.prototype._getItemLayoutPosition = function (t) {
        ...
        for (
          var e = t.size.outerWidth % this.columnWidth,
            ...
            e = Math.min.apply(Math, o),
            n = u.indexOf(o, e),
            i = { x: this.columnWidth * n, y: e },
            r = e + t.size.outerHeight,
            s = this.cols + 1 - o.length,
            a = 0;
          a < s;
          a++
        )
      ...
      (t.prototype._manageStamp = function (t) {
        ...
        for (
          var n = Math.min(this.cols - 1, n),
            r = (this.options.isOriginTop ? i.top : i.bottom) + e.outerHeight,
            s = o;
          s <= n;
          s++
        )
  ...
  (function (s, a) {
    ...
    (h.Item = n),
      ...
      (h.prototype._itemize = function () {
        for (
          var t = o.prototype._itemize.apply(this, arguments),
            e = 0,
            i = t.length;
          e < i;
          e++
      ...
      (h.prototype._filter = function (t) {
        for (
          ...
          p.isIgnored ||
            ((u = r(p)) && i.push(p),
            u && p.isHidden ? o.push(p) : u || p.isHidden || n.push(p));
        }
    ...
    (h.sortDataParsers = {
      ...
      (h.prototype._sort = function () {
        ...
        e &&
          ((t = [].concat.apply(e, this.sortHistory)),
          (a = t),
